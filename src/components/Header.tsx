const Header = () => {
    return (
        <header className="relative flex items-center justify-between px-10 py-6 bg-gradient-to-r from-[#4A3F71] to-[#5E507F] z-10">
            ...
            <div className="flex items-center relative">
                ...
                <span className="font-bold text-white text-2xl tracking-tight">Sales Agentic Chatbot 🤖</span>
            </div>
